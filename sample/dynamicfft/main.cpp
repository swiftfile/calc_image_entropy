//reference:http://opencv.jp/opencv2-x-samples/2d_dft_idft/
#include <iostream>
...
DftIdftApp::DftIdftApp(const string filename)
    ...
    namedWindow(mag_win, cv::WINDOW_AUTOSIZE);
    namedWindow(idft_win, cv::WINDOW_AUTOSIZE);
...
main(int argc, char *argv[]) {
    const string filename = argc > 1 ? argv[1] : "../soccer.jpg";
